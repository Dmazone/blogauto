// temp: build section 3 input JSON and write to stdout
const body = `대한민국에서 결혼과 출산을 기피하는 가장 큰 원인으로 주거비 부담이 해마다 손꼽힙니다. 소득 상승률에 비해 턱없이 높은 집값은 청년 세대에게 가정을 꾸릴 엄두조차 내지 못하게 만드는 거대한 장벽이 되었습니다. 정부가 잇따라 저출생 극복 주거 지원 정책을 쏟아내고 있지만, 현장의 청년들은 왜 여전히 냉소적인 걸까요?

![저출생 주거 지원 정책 현황](https://dmazone.github.io/blogauto/images/low-birth-housing-2026-01.webp)
...
![청년 주거 정책 비교](https://dmazone.github.io/blogauto/images/low-birth-housing-2026-02.webp)
...
const payload = {
  ...
  outline: {
    meta_description: "2026년 저출생 극복을 위한 주거 지원 정책의 실효성을 분석합니다. 신생아 특례대출, 청년 주택드림 통장의 명암과 청년들의 실제 반응을 알아보세요."
  },
  body: body,
  imgPrompts: [
    "Korean youth housing policy concept, apartment buildings in Seoul cityscape, young couple looking at housing brochure, soft blue tones, flat design illustration",
    "Low birth rate and housing crisis in Korea, statistical visualization, young family housing search, minimalist infographic style, no text",
    "Korean housing policy magazine cover thumbnail, modern apartment building, bold blue and white colors, 16:9 ratio, no text overlay"
  ],
  dateOverride: "2026-05-23T07:30:00+09:00"
};
