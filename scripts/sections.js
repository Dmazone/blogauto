...
export const SECTIONS = [
  {
    ...
    toneHint: '기술 분석·비교·미래 전망, 개발자 독자 눈높이',
  ...
  },
  {
    ...
    toneHint: '경제 분석, 독자 생활에 미치는 영향, 데이터 기반 해석',
  ...
  },
  {
    ...
    toneHint: '균형 있는 시각, 다양한 입장 소개, 독자 삶과 연결',
  ...
  },
  {
    ...
    toneHint: '깊이 있는 통찰, 일상과 연결되는 인문학, 독자 사고 자극',
  ...
  },
  {
    ...
    toneHint: '재미있고 가벼운 톤, 팩트 중심, 팬 관점과 일반 독자 관점 균형',
  ...
  },
  {
    ...
    toneHint: '신뢰성 있는 정보, 실천 가능한 팁, 과학적 근거 기반',
  ...
  },
  {
    ...
    toneHint: '스펙 비교 분석, 실사용자 관점 리뷰, 장단점 솔직하게',
  ...
  },
  {
    ...
    toneHint: '실수요자 관점, 투자 관련 언급 시 중립적 표현, 데이터 근거',
  ...
  },
  {
    ...
    toneHint: '설레는 여행 감성 + 실용적 정보, 직접 가본 듯한 생생한 묘사',
  ...
  },
  {
    ...
    toneHint: '팬 관점의 흥미로운 분석, 경기 결과보다 맥락·의미 해석',
