...
| 명령어 | 파일 | 설명 |
|---|---|---|
| `/post-daily` | `.Codex/commands/post-daily.md` | 22:00 포스팅 자동화 |
| `/verify-posts` | `.Codex/commands/verify-posts.md` | 08:00 발행 점검·수정 |
| `/threads-post` | `.Codex/commands/threads-post.md` | 10:00 스레드 게시·리포스트 |
